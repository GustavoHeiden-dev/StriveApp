...
<head>
   ...
   <style>
       :root {
           /* NOVOS TONS DE ROXO - UM POUCO MAIS ESCUROS */
           --soft-purple-1: #9575cd; /* Roxo médio */
           --soft-purple-2: #673ab7; /* Roxo mais intenso */
       ...
       .brand-panel {
           ...
           /* Gradiente com os novos tons mais escuros */
       ...
       /* --- O PAINEL DO FORMULÁRIO CONTINUA O MESMO --- */
       .form-panel {
           flex: 1;
           display: flex;
           justify-content: center;
