        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            <% if (treinoFinalizado) { %>
                function showEpicCelebration() {
                    ...
                    const fireworks = (particleRatio, opts) => {
                    ...
                    fireworks(0.25, { spread: 26, startVelocity: 55 });
                    fireworks(0.2, { spread: 60 });
                    fireworks(0.35, { spread: 100, decay: 0.91, scalar: 0.8 });
                    fireworks(0.1, { spread: 120, startVelocity: 25, decay: 0.92, scalar: 1.2 });
                    fireworks(0.1, { spread: 120, startVelocity: 45 });
                }

                Swal.fire({
                    title: 'VITÓRIA!',
                    html: 'Seu esforço foi recompensado. Mais um treino concluído com sucesso!',
                    icon: 'success',
                    iconColor: '#FFD700',
                    background: '#1a1a1a url(https://media.giphy.com/media/26tOZ42Mg6pbTUPHW/giphy.gif) center/cover no-repeat',
                    color: '#fff',
                    confirmButtonText: '<i class="fas fa-trophy"></i> INCRÍVEL!',
