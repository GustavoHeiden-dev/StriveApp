...
<style>
    ...
    * {
    ...
    .hero {
        height: 100vh;
        background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('imagemfUNDO.jpg') no-repeat center center/cover;
        color: var(--white-color);
        display: flex;
    ...
    /* 4. SEÇÃO DE RECURSOS (FEATURES) - ATUALIZADO */
    #features {
        background-color: var(--dark-color);
        color: var(--white-color);
    }
    ...
    .feature-card {
        background: #252525; /* Cinza escuro, um pouco mais claro que o fundo */
        padding: 2rem;
        text-align: center;
        border-radius: 10px;
        border: 1px solid #444; /* Borda sutil para dar definição */
        transition: transform 0.3s ease, box-shadow 0.3s ease;
    }
    
    .feature-card:hover {
        transform: translateY(-10px);
        box-shadow: 0 10px 20px rgba(0,0,0,0.2); /* Sombra para o efeito de elevação */
    }
...
<body>
    ...
    <script>
        ...
        // Adiciona o evento de clique no ícone hambúrguer
        hamburger.addEventListener('click', () => {
            // Alterna a classe 'nav-active' no menu para mostrar/esconder
            navLinks.classList.toggle('nav-active');
            
            // Alterna a classe 'toggle' no ícone para animar o X
