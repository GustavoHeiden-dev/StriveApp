		...
		<main class="main-content">
			<div class="main-header">
				<div>
					...
					<p>Complete os exercícios para finalizar.</p>
				</div>
			...
			<div class="exercicio-card" id="card-<%=ex.getId()%>">
				...
				<div class="exercicio-details">
					...
					<p>
						...
						<%=ex.getRepeticoes()%>
						@
						<%=(ex.getPeso() != null ? ex.getPeso() + "kg" : "Peso corporal")%></p>
				</div>
				<form class="exercicio-form" data-id="<%=ex.getId()%>">
					...
					<div class="form-row">
						<div class="form-group">
							<label for="repeticoesFeitas_<%=ex.getId()%>">Repetições
								Feitas:</label> <input type="text" name="repeticoesFeitas"
								id="repeticoesFeitas_<%=ex.getId()%>" placeholder="Ex: 3x12"
								required>
						</div>
						<div class="form-group">
							<label for="pesoUsado_<%=ex.getId()%>">Peso Usado (kg):</label>
							<input type="number" step="0.5" name="pesoUsado"
								id="pesoUsado_<%=ex.getId()%>" placeholder="Ex: 80.5">
						</div>
						<div class="form-group">
