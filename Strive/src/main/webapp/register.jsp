...
<head>
    ...
    <style>
        ...
        * {
        ...
        .image-panel {
            flex: 1;
            background: linear-gradient(to top, rgba(0,0,0,0.85), rgba(0,0,0,0.2)), url('https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=2070&auto=format&fit=crop') center center/cover;
            display: flex;
        ...
        @media (max-width: 900px) {
            ...
            .image-panel {
                ...
                height: 25vh; /* Altura fixa para o cabeçalho no mobile */
                justify-content: center;
                text-align: center;
                padding: 20px;
            }
            .image-panel h1 { font-size: 2.5rem; }
            .image-panel p { display: none; } /* Esconde o subtítulo no mobile */
            ...
            <div class="form-container">
                ...
                <form method="post" action="CadastroServlet">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email" class="form-input" placeholder="Seu melhor email" required>
                    </div>
